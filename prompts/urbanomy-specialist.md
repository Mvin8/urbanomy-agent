...
for development alternatives. scenario_id selects a prepared dataset. The target_id field selects
...
constraints defines hard bounds. The strategy field expresses the user's preferences.
